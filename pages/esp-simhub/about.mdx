---
title: About eCrowne ESP-SimHub Firmware
---
...
The eCrowne ESP-SimHub firmware is a port of the SimHub Arduino firmware to ESP devices. It enables <AffiliateLink type={ProductType.ESP8266} /> and <AffiliateLink type={ProductType.ESP32} /> microcontrollers to interface seamlessly with SimHub wirelessly and through USB, This firmware provides a bridge between the powerful capabilities of ESP devices and the rich feature set of SimHub, allowing sim racing enthusiasts to create custom hardware solutions for their racing setups.
...
- **Community Support**: The firmware is open-source and supported by sim racing enthusiasts.

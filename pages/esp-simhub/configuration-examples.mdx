...
<Callout type="info">
All examples assume you're editing the [src/main.cpp](https://github.com/eCrowneEng/ESP-SimHub/blob/main/src/main.cpp) file in your project unless otherwise specified.
</Callout>
...
There are two methods to control <AffiliateLink type={ProductType.NeoPixel}>WS2812B/NeoPixel LEDs</AffiliateLink> in ESP-SimHub. Each has its advantages:
...
- Add a capacitor (100-1000µF) across power lines to prevent brown-outs if possible.
</Callout>

## Common Issues with WS2812B LEDs

- **LED strip is slow**: Use NeoPixelBus with a non bitbang method. If this is already the case, then tame your animations or reduce the number of features in the device. Check FPS in Arduino connection tab in SimHub.

...
If you're using an <AffiliateLink type={ProductType.ESP8266} /> board, uncomment the ESP8266 environment in your [platformio.ini](https://github.com/eCrowneEng/ESP-SimHub/blob/main/platformio.ini) (this is the default):
...
#############################################
[env:esp8266]
{The code here MUST NOT be prefaced with ;}
...
#############################################
;[env:esp32]
{The code here MUST be prefaced with ;}

```

Common ESP8266 configuration:
```ini
[env:esp8266]
...
For <AffiliateLink type={ProductType.ESP32} /> boards, uncomment the ESP32 environment:
